...
class exu extends Module with lib with RequireAsyncReset{
  ...
  val i0_rs1_bypass_data_d =	Mux1H(Seq(
    io.dec_exu.decode_exu.dec_i0_rs1_bypass_en_d(0).asBool							-> io.dec_i0_rs1_bypass_data_d,
  ...
  val i0_rs2_bypass_data_d =	Mux1H(Seq(
    io.dec_exu.decode_exu.dec_i0_rs2_bypass_en_d(0).asBool							-> io.dec_i0_rs2_bypass_data_d,
